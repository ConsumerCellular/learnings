...
{
    [TestFixture]
    public class FeeTransactionTest : TransactionTests
    {
        ...
        public void CalculateTotalTransaction_AmountAndFeeProvided_ReturnsAmountMinusFee()
        {
            ...
            Assert.That(totalTransaction, Is.EqualTo(expectedTotalTransaction), "Calculated transaction should equal the base amount minus the fee.");
        }
    }
}
